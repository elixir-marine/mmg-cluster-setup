    ...
    static void createClusterVarsFile(Configuration config, String tempFolder)
    {
        ...
        try
        {
            ...
            for(int i = 0; i < lines.size(); )
            {
                ...
                else if(line.contains("nodeGroups:"))
                {
                    newLines.add(line);
                ...
                else if(line.contains("disk:") && config.getNodeGroups().contains("regularHddNodes"))
                {
                    newLines.add(line);
                ...
                else if(line.contains("ssd:") && config.getNodeGroups().contains("ioHddSsdNodes"))
                {
                    newLines.add(line);
